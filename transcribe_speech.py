...
from custom_transcribe_utils import write_transcription
...
def main(cfg: TranscriptionConfig) -> Union[TranscriptionConfig, List[Hypothesis]]:
    ...
    compute_confidence = cfg.compute_confidence
    ...
    if hasattr(asr_model, 'change_decoding_strategy'):
        ...
        # Check if ctc or rnnt model
            ...
            # confidence calculation addition
            if cfg.compute_confidence:
                cfg.ctc_decoding.confidence_cfg.preserve_frame_confidence = True
                cfg.ctc_decoding.confidence_cfg.preserve_word_confidence = True           
